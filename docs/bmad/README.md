...
| **Epics** | [epics.md](../../_bmad-output/planning-artifacts/epics.md) | Phased delivery map |
...
3. Adjust `epics.md` and `gap-analysis.md`.
4. Run Caffeine verification flows under `.caf/.../verification/`.
