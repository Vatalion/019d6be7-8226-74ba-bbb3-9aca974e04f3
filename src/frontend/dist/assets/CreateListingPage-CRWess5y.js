import { c as createLucideIcon, r as reactExports, q as useComposedRefs, j as jsxRuntimeExports, m as cn, e as useLocale, A as LoaderCircle, x as useInternetIdentity, b as useAuth, n as useActor, C as useUploadFile, w as useQueryClient, u as useNavigate, d as detectLocale, i as ListingCategory, k as ItemCondition, y as TradeToken, h as useQuery, t, z as ue, S as Skeleton, B as Button, R as RefreshCw, L as LogIn, p as createActor } from "./index-BWWoZgQl.js";
import { I as Input } from "./input-CR8lQ-TV.js";
import { L as Label } from "./label-B1jsMbQH.js";
import { u as usePrevious, S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-CY6VZ8xn.js";
import { u as useControllableState, P as Primitive, c as composeEventHandlers, b as createContextScope } from "./index-C4j9Z2CH.js";
...
import { C as ChevronDown } from "./chevron-up-DDm1bD-d.js";
import { C as CircleCheck } from "./circle-check-BhAvNT3V.js";
import { A as ACTIVE_PHYSICAL_SHIPPING_CARRIER, S as ShippingProviderSelector, g as getPhysicalShippingMethods } from "./ShippingProviderSelector-CQrMAcvl.js";
import { A as ArrowLeft, U as Upload } from "./upload-D_91OjtM.js";
import { C as Copy } from "./copy-BGQ2df2e.js";
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-card shadow-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 sm:p-8", children: [
          step === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", "data-ocid": "step-basic-info", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "category", className: "text-label", children: tl("create.field.category") }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Select,
                {
                  value: form.category,
          ...
          step === 2 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", "data-ocid": "step-photos", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border bg-muted/20 p-4 space-y-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-x-4 gap-y-2 text-sm", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-foreground", children: ((_b = CATEGORIES.find((c) => c.value === form.category)) == null ? void 0 : _b.label) ?? "—" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: tl("create.field.condition") }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-foreground", children: ((_c = CONDITIONS.find((c) => c.value === form.condition)) == null ? void 0 : _c.label) ?? "—" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: tl("create.field.price") }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono font-bold text-foreground", children: form.priceAmount ? `${form.priceAmount} ${(_d = TOKENS.find((tk) => tk.value === form.priceToken)) == null ? void 0 : _d.label}` : "—" }),
