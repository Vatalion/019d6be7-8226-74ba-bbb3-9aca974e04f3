...
workflowType: story
storyId: "E6.S3"
storyKey: "e6-s03-reputation-tiers"
epic: "E6"
phase: 1
status: done
prd: "FR-43"
...
# Story E6.S3: Reputation tiers and trade limits
...
As the platform, I want progressive trade limits based on reputation tier.

## Acceptance Criteria

1. Given user tier, when trade amount exceeds limit, then initiation blocked with clear message.

### BDD Scenarios

- **Scenario: Acceptance 1**
  - Given user tier
  - When trade amount exceeds limit
  - Then initiation blocked with clear message.
...
|------|-------------|--------|----------|
| 1 | Given user tier, when trade amount exceeds limit, then initiation blocked with clear message. | Pass (regression) | test/Reputation.test.mo |

### BDD scenario validation

- [x] Scenario 1: user tier, when trade amount exceeds limit, then initiation blocked with clear message.
