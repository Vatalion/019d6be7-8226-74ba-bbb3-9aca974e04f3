...
# Story E6.S1: Open dispute with evidence
...
As a trade participant, I want to open a dispute with evidence when the deal fails.

## Acceptance Criteria

1. Given eligible trade state, when dispute opened with reason/evidence, then dispute record created.

### BDD Scenarios

- **Scenario: Acceptance 1**
  - Given eligible trade state
  - When dispute opened with reason/evidence
  - Then dispute record created.
...
| FR-40 | [traceability-matrix.md](../../../planning-artifacts/traceability-matrix.md) |
...
- [prd.md](../../../planning-artifacts/prd.md) — FR-40
...
|------|-------------|--------|----------|
| 1 | Given eligible trade state, when dispute opened with reason/evidence, then dispute record created. | Pass (regression) | test/Disputes.test.mo |

### BDD scenario validation

- [x] Scenario 1: eligible trade state, when dispute opened with reason/evidence, then dispute record created.
