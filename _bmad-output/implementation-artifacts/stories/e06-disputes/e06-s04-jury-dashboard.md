...
workflowType: story
storyId: "E6.S4"
storyKey: "e6-s04-jury-dashboard"
epic: "E6"
phase: 3
...
# Story E6.S4: Jury dashboard and voting
...
As a juror, I want to see assigned cases and vote when community resolution is enabled.

## Acceptance Criteria

1. Given jury mode enabled, when juror votes, then tally and timelock rules apply.

### BDD Scenarios

- **Scenario: Acceptance 1**
  - Given jury mode enabled
  - When juror votes
  - Then tally and timelock rules apply.
...
| FR-42 | [traceability-matrix.md](../../../planning-artifacts/traceability-matrix.md) |
...
- `Disputes.test.mo` (backend)
- No golden-path flow — deferred

## References
- [epics.md](../../../planning-artifacts/epics.md)
- [prd.md](../../../planning-artifacts/prd.md) — FR-42
...
|------|-------------|--------|----------|
| 1 | Given jury mode enabled, when juror votes, then tally and timelock rules apply. | Smoke — code present | test/Disputes.test.mo |

### BDD scenario validation

- [ ] Scenario 1: jury mode enabled, when juror votes, then tally and timelock rules apply.
