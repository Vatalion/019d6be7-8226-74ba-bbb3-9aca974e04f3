...
workflowType: story
storyId: "E8.S1"
storyKey: "e8-s01-admin-dashboard"
epic: "E8"
phase: 1
status: done
prd: "FR-60"
...
As an admin, I want operational dashboards for users, disputes, and system health.

## Acceptance Criteria

1. Given admin role, when I open /admin, then key queues and metrics visible.
...
- **Scenario: Acceptance 1**
  - Given admin role
  - When I open /admin
  - Then key queues and metrics visible.
...
|------|-------------|--------|----------|
| 1 | Given admin role, when I open /admin, then key queues and metrics visible. | Pass (regression) | test/Admin.test.mo |

### BDD scenario validation

- [x] Scenario 1: admin role, when I open /admin, then key queues and metrics visible.
