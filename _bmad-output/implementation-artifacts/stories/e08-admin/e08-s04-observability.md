...
# Story E8.S4: Observability metrics
...
As an admin, I want latency/volume/health metrics for the canister.

## Acceptance Criteria

1. Given traffic, when dashboard loaded, then P95/error/volume charts render.
...
- **Scenario: Acceptance 1**
  ...
  - Then P95/error/volume charts render.
...
| FR-61 | [traceability-matrix.md](../../../planning-artifacts/traceability-matrix.md) |
...
- [prd.md](../../../planning-artifacts/prd.md) — FR-61
...
|------|-------------|--------|----------|
| 1 | Given traffic, when dashboard loaded, then P95/error/volume charts render. | Pass (regression) | src/frontend/src/components/admin/Phase2MetricsPanel.tsx |

### BDD scenario validation

- [x] Scenario 1: traffic, when dashboard loaded, then P95/error/volume charts render.
