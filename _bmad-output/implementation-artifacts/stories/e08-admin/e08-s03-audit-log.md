...
As an admin, I want an audit log of sensitive actions.

## Acceptance Criteria

1. Given admin action (ban, settings), when performed, then audit entry recorded.

### BDD Scenarios

- **Scenario: Acceptance 1**
  - Given admin action (ban, settings)
  - When performed
  - Then audit entry recorded.
...
|------|-------------|--------|----------|
| 1 | Given admin action (ban, settings), when performed, then audit entry recorded. | Pass (regression) | test/Admin.test.mo |

### BDD scenario validation

- [x] Scenario 1: admin action (ban, settings), when performed, then audit entry recorded.
