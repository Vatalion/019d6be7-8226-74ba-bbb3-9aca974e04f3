...
workflowType: story
storyId: "E2.S9"
storyKey: "e2-s09-report-listing"
epic: "E2"
phase: 2
status: done
prd: "—"
...
As a user, I want to report a listing for moderation review.

## Acceptance Criteria

1. Given listing detail, when I report with reason, then admin audit receives entry.

### BDD Scenarios

- **Scenario: Acceptance 1**
  - Given listing detail
  - When I report with reason
  - Then admin audit receives entry.
...
|------|-------------|--------|----------|
| 1 | Given listing detail, when I report with reason, then admin audit receives entry. | Pass (regression) | src/frontend/src/pages/ListingDetailPage.tsx |

### BDD scenario validation

- [x] Scenario 1: listing detail, when I report with reason, then admin audit receives entry.
