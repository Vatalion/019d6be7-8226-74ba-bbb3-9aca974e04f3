...
workflowType: story
storyId: "E2.S10"
storyKey: "e2-s10-olx-category-attributes"
epic: "E2"
phase: 3
status: done
...
# Story E2.S10: Category-specific attributes (auto, RE)
...
As a buyer, I want vertical-specific fields (year, mileage, rooms, m²) like OLX.

## Acceptance Criteria

1. Given vertical config, when create listing in auto, then make/model/year fields required.

### BDD Scenarios

- **Scenario: Acceptance 1**
  - Given vertical config
  - When create listing in auto
  - Then make/model/year fields required.
...
- category attribute schema on Listing
...
- Extend CategoryCatalog attribute schema
- `Marketplace.test.mo` vertical fields
...
|------|-------------|--------|----------|
| 1 | Given vertical config, when create listing in auto, then make/model/year fields required. | Pass (regression) | test/Marketplace.test.mo |

### BDD scenario validation

- [x] Scenario 1: vertical config, when create listing in auto, then make/model/year fields required.
