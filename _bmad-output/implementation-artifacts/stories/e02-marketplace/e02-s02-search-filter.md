...
# Story E2.S2: Search and filter listings
...
As a buyer, I want to search and filter listings so I can find relevant offers quickly.

## Acceptance Criteria

1. Given active listings, when I search by keyword, then matching listings appear.
2. Given filters, when I apply price/category/token filters, then results respect constraints.
3. Given filters applied, when I clear, then full active index returns.
...
- **Scenario: Acceptance 2**
  - Given filters
  - When I apply price/category/token filters
  - Then results respect constraints.
- **Scenario: Acceptance 3**
  - Given filters applied
  - When I clear
  - Then full active index returns.
...
| FR-11 | [traceability-matrix.md](../../../planning-artifacts/traceability-matrix.md) |
...
- [prd.md](../../../planning-artifacts/prd.md) — FR-11
...
|------|-------------|--------|----------|
| 1 | Given active listings, when I search by keyword, then matching listings appear. | Pass (regression) | test/Marketplace.test.mo |
| 2 | Given filters, when I apply price/category/token filters, then results respect constraints. | Pass (regression) | src/frontend/src/pages/ListingsPage.tsx |
| 3 | Given filters applied, when I clear, then full active index returns. | Pass (regression) | |

### BDD scenario validation

- [x] Scenario 1: active listings, when I search by keyword, then matching listings appear.
- [x] Scenario 2: filters, when I apply price/category/token filters, then results respect constraints.
- [x] Scenario 3: filters applied, when I clear, then full active index returns.
