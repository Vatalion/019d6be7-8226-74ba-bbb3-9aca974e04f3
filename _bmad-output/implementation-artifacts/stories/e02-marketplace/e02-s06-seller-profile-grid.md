...
workflowType: story
storyId: "E2.S6"
storyKey: "e2-s06-seller-profile-grid"
epic: "E2"
phase: 1
status: done
prd: "FR-15"
...
# Story E2.S6: Seller profile and listings grid
...
As a buyer, I want to see all active listings from a seller on their profile page.

## Acceptance Criteria

1. Given seller with listings, when I visit profile, then grid shows only their active listings.

### BDD Scenarios

- **Scenario: Acceptance 1**
  - Given seller with listings
  - When I visit profile
  - Then grid shows only their active listings.
...
- searchListings filtered by seller principal
...
| FR-15 | [traceability-matrix.md](../../../planning-artifacts/traceability-matrix.md) |
...
- [prd.md](../../../planning-artifacts/prd.md) — FR-15
...
|------|-------------|--------|----------|
| 1 | Given seller with listings, when I visit profile, then grid shows only their active listings. | Pass (regression) | src/backend/lib/Marketplace.mo |

### BDD scenario validation

- [x] Scenario 1: seller with listings, when I visit profile, then grid shows only their active listings.
