...
workflowType: story
storyId: "E2.S5"
storyKey: "e2-s05-deactivate-listing"
epic: "E2"
phase: 1
status: done
prd: "FR-14"
...
# Story E2.S5: Deactivate listing
...
As a seller, I want to deactivate my listing with confirmation so it no longer appears in search.

## Acceptance Criteria

1. Given active listing I own, when I deactivate and confirm, then status is inactive and hidden from browse.

### BDD Scenarios

- **Scenario: Acceptance 1**
  - Given active listing I own
  - When I deactivate and confirm
  - Then status is inactive and hidden from browse.
...
| FR-14 | [traceability-matrix.md](../../../planning-artifacts/traceability-matrix.md) |
...
- [prd.md](../../../planning-artifacts/prd.md) — FR-14
...
|------|-------------|--------|----------|
| 1 | Given active listing I own, when I deactivate and confirm, then status is inactive and hidden from browse. | Pass (regression) | test/Marketplace.test.mo |

### BDD scenario validation

- [x] Scenario 1: active listing I own, when I deactivate and confirm, then status is inactive and hidden from browse.
