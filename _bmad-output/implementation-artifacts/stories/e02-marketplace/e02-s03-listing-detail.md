...
workflowType: story
storyId: "E2.S3"
storyKey: "e2-s03-listing-detail"
epic: "E2"
phase: 1
status: done
prd: "FR-12"
...
# Story E2.S3: Listing detail and buy CTA
...
As a buyer, I want to view listing details and start a trade from a clear buy action.

## Acceptance Criteria

1. Given active listing, when I open detail, then photos, price, token, seller card render.
2. Given logged out, when I click buy, then sign-in guard appears.
...
- **Scenario: Acceptance 1**
  ...
  - When I open detail
  - Then photos, price, token, seller card render.
- **Scenario: Acceptance 2**
  - Given logged out
  - When I click buy
  - Then sign-in guard appears.
...
- Flow: listing-detail-public-shell
- Flow: listing-buy-signin-guard

### Verification checklist (story manifest)

- Flow: `listing-buy-signin-guard`, `listing-detail-public-shell`
...
|------|-------------|--------|----------|
| 1 | Given active listing, when I open detail, then photos, price, token, seller card render. | Pass (regression) | src/frontend/src/pages/ListingDetailPage.tsx |
| 2 | Given logged out, when I click buy, then sign-in guard appears. | Pass (regression) | src/frontend/src/lib/initiateListingTrade.ts |

### BDD scenario validation

- [x] Scenario 1: active listing, when I open detail, then photos, price, token, seller card render.
- [x] Scenario 2: logged out, when I click buy, then sign-in guard appears.
