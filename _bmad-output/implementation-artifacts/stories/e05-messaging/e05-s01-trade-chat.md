...
As trade participants, we want a private chat thread tied to the trade.

## Acceptance Criteria

1. Given trade, when either party sends message, then other sees it in trade chat.

### BDD Scenarios

- **Scenario: Acceptance 1**
  - Given trade
  - When either party sends message
  - Then other sees it in trade chat.
...
| FR-30 | [traceability-matrix.md](../../../planning-artifacts/traceability-matrix.md) |
...
- [prd.md](../../../planning-artifacts/prd.md) — FR-30
...
|------|-------------|--------|----------|
| 1 | Given trade, when either party sends message, then other sees it in trade chat. | Pass (regression) | test/Messaging.test.mo |

### BDD scenario validation

- [x] Scenario 1: trade, when either party sends message, then other sees it in trade chat.
