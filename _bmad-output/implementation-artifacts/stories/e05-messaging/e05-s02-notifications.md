...
# Story E5.S2: Unread counts and toasts
...
As a user, I want notification toasts and unread badges for messages and trade events.

## Acceptance Criteria

1. Given unread messages, when polling runs, then badge count updates.
2. Given trade deadline near, when threshold hit, then warning toast shown.
...
| FR-31 | [traceability-matrix.md](../../../planning-artifacts/traceability-matrix.md) |
...
- [prd.md](../../../planning-artifacts/prd.md) — FR-31
...
|------|-------------|--------|----------|
| 1 | Given unread messages, when polling runs, then badge count updates. | Pass (regression) | src/frontend/src/contexts/NotificationContext.tsx |
| 2 | Given trade deadline near, when threshold hit, then warning toast shown. | Pass (regression) | |

### BDD scenario validation

- [x] Scenario 1: unread messages, when polling runs, then badge count updates.
- [x] Scenario 2: trade deadline near, when threshold hit, then warning toast shown.
